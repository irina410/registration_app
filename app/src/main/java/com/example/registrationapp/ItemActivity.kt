...
class ItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add(Item(5, "cutie_kysya", "Kysya looks so cute", "Mamma mia! What a fantastic cat! Its graceful posture, silky grey fur and green eyes make it a true queen. So elegant and sophisticated that I want to take a breath. Its playful behavior and affectionate attitude towards others leave no one indifferent. This cat is a princess who deserves only the best attention and care. " , 1000000000)) //Кыся выглядит такой милой, что хочется затискать ее до смерти, задушить в объятиях и гладить до тех пор, пока у вас не отвалится рука.
